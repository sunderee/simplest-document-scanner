...
# Run `pod lib lint simplest_document_scanner.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
...
Simplest document scanning plugin powered by VisionKit on iOS and MLKit on Android
  ...
  # s.resource_bundles = {'simplest_document_scanner_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
